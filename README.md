...
> **Nota**: El campo `role` **no** es aceptado. Todos los usuarios se crean como `"user"`.
> **Política de contraseña**: mínimo 8 caracteres, al menos 1 mayúscula, 1 minúscula y 1 número.
